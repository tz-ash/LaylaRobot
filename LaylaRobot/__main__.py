...
PM_START_TEXT = """
ʜᴇʟʟᴏ [👋](https://telegra.ph/file/87b783a4a10923da9ad69.jpg), ɪ'ᴍ ʟʏᴄɪ
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/LyciRobot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/zairalogs"),
        InlineKeyboardButton(
            text="ᴘʏꜱᴋɪᴅ", url=f"https://t.me/kidhub"
        ),
    ],
    [
...
layla_IMG = "https://telegra.ph/file/87b783a4a10923da9ad69.jpg"
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Lyci*, a powerful group management bot built to help you manage your group easily.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Lyci*
                 \nHere is the [Source Code](https://t.me/kidbots) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
